...
export const AnimatedBeam: React.FC<AnimatedBeamProps> = ({
  ...
  duration = 4,
  delay = 0,
  pathColor = "rgba(196, 164, 124, 0.3)",
  pathWidth = 2,
  pathOpacity = 0.4,
  gradientStartColor = "#C4A47C",
  gradientStopColor = "#C96B38",
  startXOffset = 0,
  startYOffset = 0,
  endXOffset = 0,
  endYOffset = 0,
  ...
  const [gradientX1, setGradientX1] = useState("10%");
  ...
  useEffect(() => {
    const startVal = reverse ? 90 : 10;
    const endVal = reverse ? -10 : 110;
